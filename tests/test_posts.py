...
def test_get_all_posts(authorized_client, test_posts):
    ...
    def validate(post):
        return schema.PostJoinResponse(**post)
...
def test_get_one_post(authorized_client, test_posts):
    ...
    post = schema.PostJoinResponse(**res.json())
...
@pytest.mark.parametrize(
    ...
    [
        ...
        ("awesome old title", "awesome old content", True),
        ("awesome aged title", "awesome aged content", False),
...
def test_create_default_published(authorized_client, test_user, test_posts):
    res = authorized_client.post(
